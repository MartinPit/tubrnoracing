...
export function Hero({ title = "TU BRNO RACING" }: Props) {
  ...
  return (
    <div ref={container} className="relative z-20 text-center px-6 flex flex-col items-center gap-10">
      ...
      {/* Flip words line */}
      <div className="hero-flip text-lg sm:text-xl text-muted-foreground tracking-wide flex flex-wrap items-center justify-center gap-1">
        <span>Expect</span>
        <FlipWords
          words={FLIP_WORDS}
          duration={2800}
      ...
      {/* Countdown */}
      <div className="flex items-center gap-4 sm:gap-8" suppressHydrationWarning>
